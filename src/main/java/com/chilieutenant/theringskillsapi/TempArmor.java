...
public class TempArmor {
	 ...
	 *            - can be set later.
	 */
	public TempArmor(final LivingEntity entity, final MainAbility ability, final ItemStack[] armorItems) {
	 ...
	 *            - can be set later.
	 */
	public TempArmor(final LivingEntity entity, long duration, final MainAbility ability, final ItemStack[] armorItems) {
		if (duration <= 0) {
